...
const size_t SOC_NUM_HW_WINDOWS = 7;        // MAX_DECON_WIN
const size_t SOC_WIN_STATE_DISABLED = 0;    // DECON_WIN_STATE_DISABLED
const size_t SOC_WIN_STATE_COLOR = 1;       // DECON_WIN_STATE_COLOR
const size_t SOC_WIN_STATE_BUFFER = 2;      // DECON_WIN_STATE_BUFFER
const size_t SOC_BLENDING_NONE = 0;         // DECON_BLENDING_NONE
const size_t SOC_BLENDING_MAX = 3;          // DECON_BLENDING_MAX
const size_t SOC_PIXEL_FORMAT_MAX = 21;     // DECON_PIXEL_FORMAT_MAX

inline size_t halBlendingToSocBlending(int32_t blending)
{
    switch (blending) {
...
inline size_t halFormatToSocFormat(int format)
{
    switch (format) {
